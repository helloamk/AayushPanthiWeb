document.addEventListener("DOMContentLoaded", () => {
    ...
    `;
        ...
        if (!document.getElementById("footer-style")) {
            ...
            style.textContent = `
            .footer-bottom {
                background: linear-gradient(135deg, #0f2027 0%, #142f3a 50%, #1e3f52 100%);
                color: #f0f5ff;
                text-align: center;
                padding: 3.2rem 1.5rem 4.5rem;       /* ← more bottom padding = more space below */
                border-top: 1px solid rgba(255, 211, 105, 0.22);
                box-shadow: 
                    0 -12px 40px rgba(0,0,0,0.6),
                    inset 0 3px 14px rgba(255,255,255,0.06);
            ...
            .footer-bottom::before {
                ...
                background: linear-gradient(
                    120deg,
                    transparent 38%,
                    rgba(255, 211, 105, 0.08) 50%,
                    transparent 62%
                );
                animation: gentle-shine 15s linear infinite;
                pointer-events: none;
            }

            @keyframes gentle-shine {
                0%   { transform: translateX(-130%) translateY(-90%); }
                100% { transform: translateX(130%)  translateY(90%);  }
            }
            ...
            .copyright {
                ...
                text-shadow: 0 1.5px 6px rgba(0,0,0,0.75);
            }
            ...
            .designer-link {
                display: inline-flex;
                align-items: center;
                margin: 0.4rem 0 1.2rem;           /* ← extra bottom margin here too */
                padding: 0.55rem 1.4rem;
                font-size: 1.28rem;
                font-weight: 800;
                color: #000000;
                background: linear-gradient(135deg, #ffd369 0%, #ffca28 45%, #ffb703 100%);
                border-radius: 999px;
                text-decoration: none;
                box-shadow: 
                    0 10px 28px rgba(255, 211, 105, 0.55),
                    0 3px 10px rgba(0, 0, 0, 0.3);
                transition: all 0.38s cubic-bezier(0.175, 0.885, 0.32, 1.4);
                position: relative;
                overflow: hidden;
            }
            ...
            .designer-link:hover {
                ...
                box-shadow: 
                    0 18px 45px rgba(255, 211, 105, 0.75),
